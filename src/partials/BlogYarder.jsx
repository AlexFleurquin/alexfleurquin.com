...
import YarderProjet from '../images/yarder_projet.jpeg';
            ...
            <article>
              ...
              <header className="mb-8">
                ...
                <div className="text-center md:text-left">
                  <h1 className="h1 mb-4 font-custom text-gray-700 dark:text-white" data-aos="fade-up">yarder.</h1>
                  <p className="text-xl text-gray-600 dark:text-gray-300" data-aos="fade-up" data-aos-delay="200">Suivez simplement et sereinement vos projets de rénovation</p>
                </div>
                {/* Article meta */}
                <div className="md:flex md:items-center md:justify-between mt-3">
                  ...
                  <div className="flex items-center justify-center" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div>
                      <Link to="#" className="font-medium text-gray-200 hover:text-gray-100 transition duration-150 ease-in-out">Alexandre Fleurquin</Link>
                      <span className="text-gray-700"> - </span>
                      <span className="text-gray-500">16 Septembre 2022</span>
                    </div>
                  </div>
                  {/* Article tags */}
              ...
              <figure className="mb-8 lg:-ml-32 lg:-mr-32" data-aos="fade-up" data-aos-delay="600">
                <img className="w-full" src={YarderProjet} width="1024" height="576" alt="News single" />
              </figure>
              ...
              <div className="text-lg text-gray-400">
                ...
                <figure className="mb-8">
                  <img className="w-full" src={Cover} width="768" height="432" alt="News inner" />
