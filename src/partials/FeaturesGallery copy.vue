    ...
    <div class="max-w-6xl mx-auto pt-40">
      ...
      <div class="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
        ...
        <div class="md:col-span-5 lg:col-span-5 md:mb-0 text-center md:text-left">
          ...
          <h2 class="h2 font-red-hat-display mb-4">Concevoir le monde <br>de demain</h2>
          ...
          <div class="col-span-3">
            <div class="w-full h-64 rounded-md overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1547949003-9792a18a2601?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80')">
        ...
        <div class="max-w-6xl mx-auto px-4 pt-40 sm:px-6">
        <div>
